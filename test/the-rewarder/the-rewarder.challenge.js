...
describe('[Challenge] The rewarder', function () {
    ...
    before(async function () {
        ...
        // 部署攻击者合约
        this.attackContract = await AttackContract.deploy(this.liquidityToken.address, this.rewarderPool.address, this.flashLoanPool.address, this.rewardToken.address);
