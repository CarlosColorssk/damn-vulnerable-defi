...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        // 为了可以借到更多的token=> 降低抵押金额-> exchangeContract balance 尽量低 token balance 尽量高
        // 攻击者所有的token给exchange contract 1：增加exchangeContract的 balance token 2： 方便可以通过交换，减少exchangeContract中的eth数量
