...
describe('[Challenge] Selfie', function () {
    ...
    before(async function () {
        ...
        const AttackSelfieContract = await  ethers.getContractFactory('AttackSelfieContract', attacker);
        ...
        this.attackSelfieContract = await AttackSelfieContract.deploy(this.governance.address, this.pool.address, this.token.address);
    ...
    it('Exploit', async function () {
        ...
        await this.attackSelfieContract.attack();
        await ethers.provider.send('evm_increaseTime', [5*24*60*60]);
        await this.attackSelfieContract.attackByGov();
    });
